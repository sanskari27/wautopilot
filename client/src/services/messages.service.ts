			...
			return (
				...
				[].map((message: any) => {
					return {
						...
						received_at: message.status ?? '',
						delivered_at: message.status ?? '',
						read_at: message.status ?? '',
						sent_at: message.status ?? '',
						seen_at: message.status ?? '',
						message_id: message.status ?? '',
						failed_at: message.status ?? '',
						failed_reason: message.status ?? '',
