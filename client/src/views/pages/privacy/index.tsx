...
// - Name, email address, and phone number for communication
// - Company name, address, and phone number during account registration
...
// - Analyze website usage for improvements
// - Develop new features and functionalities
// - Communicate directly with you for customer service, updates, and marketing
...
// Like many websites, Wautopilot uses log files to collect information about visitors. This includes:
// - IP addresses
// - Browser type
...
// This information is not personally identifiable and is used for analyzing trends, administering the site, tracking users’ movements around the site, and gathering demographic information.

// **Cookies and Web Beacons**

// Wautopilot uses cookies to:
// - Store information about visitors’ preferences
// - Record user-specific information on which pages users access or visit
...
// We implement a variety of security measures to protect your personal information. While we strive to use commercially acceptable means to protect your data, no method of transmission over the internet or electronic storage is 100% secure.

// **Data Retention**

// We retain personal data only for as long as necessary to provide you with our services and for legitimate and essential business purposes, such as maintaining the performance of our services, making data-driven business decisions, complying with our legal obligations, and resolving disputes.

// Data Breach Procedures
// In the event of a data breach, we will promptly notify you and any applicable regulatory bodies of the breach, as required by law. We will also take all necessary steps to mitigate the breach and prevent future occurrences.

// **Children’s Information**

// We prioritize protecting children’s online privacy. If you believe that your child under 13 has provided personal information on our website, please contact us immediately, and we will promptly take steps to remove such information.
...
// For any questions or suggestions about our Privacy Policy, feel free to contact us. Your privacy is important to us, and we are here to help.
